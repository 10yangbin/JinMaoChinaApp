package com.guomao.propertyservice.widget.barcode;

import java.io.IOException;

import com.jinmaochina.propertyservice.R;
import com.guomao.propertyservice.util.StringUtil;
import com.guomao.propertyservice.widget.camera.CameraManager;
...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	private CheckBox toggleLightCBX;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		toggleLightCBX = (CheckBox)findViewById(R.id.toggleLight);
		toggleLightCBX.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	...
	protected void onPause() {
		...
		//flag 为false时灯是开着的
		if(!flag){
			toggleLightCBX.setChecked(false);
			flag = true;
		}
