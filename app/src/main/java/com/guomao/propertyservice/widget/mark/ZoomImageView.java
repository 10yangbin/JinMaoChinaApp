...
/**
 * 
 * @author yang.liu 放缩并添加标记的自定义view
 */
...

{
	...
	private static final float SCALE_MID = 4.0f;
	...
	public void isDoubleClick(boolean isClick) {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (flag && isClick) {
			// Log.e(tag, msg)
			canvas.drawBitmap(mark, move_x, move_y, null);
			// save all clip
			canvas.save();// 保存
			// store
			canvas.restore();// 存储
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
             ...
             if(moveTime<200&&moveX<20&&moveY<20&&!isClick){  
            	 context.finish();
             }  
	...
	public void setMark(Bitmap mark) {
		this.mark = mark;
	}
